...
#define STRING_CONFIG_H_AUTHOR "(Pandaman09, default config)" // Who made the changes.
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE+10) //+10 is safe max on X (some travel remaining)
#define Y_MAX_POS (Y_BED_SIZE+40) //+40 is safe max on Y (some travel remaining)
